...
class SkeletonDatabase:
    names = ['Mixamo', 'Elephant', 'Crab_dance', 'Xia', 'Walking']
    corps_names = [mixamo_corps_name, elephant_corps_name, crab_dance_corps_name, xia_corps_name, walking_corps_name]
    contact_names = [mixamo_contact_name, elephant_contact_name, crab_dance_contact_name, xia_contact_name, walking_contact_name]
